  ...
  projects: [
    {
      ...
      category: "개인 프로젝트",
      simulatorUrl: "https://gungeon-heroes-simulator.netlify.app/",
      ...
      accent: "#4ebcff",
      documents: [
        { id: "proposal", title: "개발제안서", description: "Gungeon Heroes 개발제안서 입니다.", file: "documents/gungeon-heroes/Gungeon_Heroes_Development_Proposal.pdf" },
        { id: "proposal", title: "게임 스토리 & 시나리오", description: "Gungeon Heroes 게임 스토리와 시나리오 입니다.", file: "documents/gungeon-heroes/Gungeon_Heroes_GameStory&Scenario.pdf" },
        { id: "character", title: "캐릭터 컨셉 기획서", description: "Gungeon Heroes 캐릭터 컨셉 입니다.", file: "documents/gungeon-heroes/Gungeon_Heroes_Character_Concept.pdf" },
        { id: "environment", title: "배경 컨셉 기획서", description: "Gungeon Heroes 배경 컨셉 입니다.", file: "documents/gungeon-heroes/Gungeon_Heroes_Background_Concept.pdf" },
        { id: "system", title: "게임 메카닉스 기획서", description: "Gungeon Heroes 게임 메카닉스 입니다.", file: "documents/gungeon-heroes/Gungeon_Heroes_Game_Mechanics.pdf" },
        { id: "system", title: "게임 콘텐츠 시스템 기획서", description: "Gungeon Heroes 게임 콘텐츠 시스템 입니다.", file: "documents/gungeon-heroes/Gungeon_Heroes_Game_Content_System.pdf" },
        { id: "level", title: "레벨 디자인 기획서", description: "Gungeon Heroes 레벨 디자인 입니다.", file: "documents/gungeon-heroes/Gungeon_Heroes_Level_Design.pdf" },
        { id: "ui", title: "게임 UI 디자인 기획서", description: "Gungeon Heroes UI 디자인 입니다.", file: "documents/gungeon-heroes/Gungeon_Heroes_UI_Design.pdf" },
        { id: "service", title: "게임 서비스 기획서", description: "Gungeon Heroes 게임 서비스 입니다.", file: "documents/gungeon-heroes/Gungeon_Heroes_Service.pdf" },
...

    {
      ...
      accent: "#ae78dc",
      documents: [
        { id: "proposal", title: "게임 스토리", description: "구천을 기는 용 게임 스토리 입니다.", file: "documents/dragon-ascension/구천을_기는_용_GameStory.pdf" },
        { id: "proposal", title: "게임 시나리오", description: "구천을 기는 용 게임 시나리오 입니다.", file: "documents/dragon-ascension/구천을_기는_용_Scenario.pdf" },
        { id: "environment", title: "레벨 컨셉 기획서", description: "구천을 기는 용 레벨 컨셉 입니다.", file: "documents/dragon-ascension/구천을_기는_용_Chapter_3_4_Level_Concept.pdf" },
        { id: "level", title: "레벨 디자인 기획서", description: "구천을 기는 용 레벨 디자인 입니다.", file: "documents/dragon-ascension/구천을_기는_용_Chapter_3_4_Level_Design.pdf" },
        { id: "level", title: "레벨 테스트 시나리오 기획서", description: "구천을 기는 용 레벨 테스트 시나리오 입니다.", file: "documents/dragon-ascension/구천을_기는_용_Chapter_3_4_Test_Scenario.pdf" },
        { id: "level", title: "레벨 분석서", description: "구천을 기는 용 레벨 분석서 입니다.", file: "documents/dragon-ascension/구천을_기는_용_Chapter_3_4_Level_Analysis.pdf" },
      ]
    }
  ],
